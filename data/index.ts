...
export const projects = [
  ...
  },
  {
    ...
    title: "TMSaaS",
    // des2: "Telecommunication Infrastructure",
    des: "A collection of API's. it serves as the interface for developers /businesses to access array of API’s for their development & business’s needs. Available API’s include: Payment, notification, Authentication API’s etc.",
    img: "/projects/tmsaas.png",
    iconLists: [
      "/re.svg",
      "/ts.svg",
      "/tail.svg",
  ...
  },
  {
    ...
    title: "Party Time",
    // des2: "Telecommunication Infrastructure",
    des: "An hosting and celebrating virtual events platform. it lets guests join the fun and spray money to the host or attendees",
    img: "/projects/party.png",
    iconLists: [
      "/re.svg",
      // "/ts.svg",
      "/tail.svg",
...
export const workExperience = [
  {
    ...
    desc: "Assisted in the development of a web-based platform using React.js, Angular, React Native enhancing interactivity.",
  ...
  },
  {
    ...
    desc: "Led the design and development of responsive, scalable web solutions while ensuring code quality and on-time delivery.",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
    locay: "@ HQTEC INC.",
  ...
  },  
  {
    ...
    desc: "Delivered personalized training on core frontend technologies, equipping students with practical skills to excel in web development.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
    locay: "@ Freelance",
    link: "#",
